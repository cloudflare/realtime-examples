/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=scripts/typegen.env --strict-vars=false` (hash: 2282121dbc6041e3fef231c7cc09c676)
// Runtime types generated with workerd@1.20260826.1 2026-08-27 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	AUTH_MODE: string;
	ROOM_STALE_SECONDS: string;
	ROOMS: DurableObjectNamespace<import("./src/worker").VideoRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "VideoRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_MODE" | "ROOM_STALE_SECONDS">> {}
}
