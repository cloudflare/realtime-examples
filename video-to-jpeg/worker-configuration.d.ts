/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fdc0547ee639106417c2f0f6eb1b8ed1)
// Runtime types generated with workerd@1.20251113.0 2025-08-06 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "VideoAdapter";
	}
	interface Env {
		SFU_API_BASE: "https://rtc.live.cloudflare.com/v1";
		REALTIME_SFU_APP_ID: string;
		REALTIME_SFU_BEARER_TOKEN: string;
		VIDEO_ADAPTER: DurableObjectNamespace<import("./src/index").VideoAdapter>;
	}
}
