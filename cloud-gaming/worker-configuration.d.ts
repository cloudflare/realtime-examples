/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=scripts/typegen.env --strict-vars=false` (hash: 29844c03fb240ab61db37a77dfb982d0)
// Runtime types generated with workerd@1.20260826.1 2026-09-02 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	AUTH_MODE: string;
	REALTIME_SFU_APP_ID: string;
	REALTIME_SFU_BEARER_TOKEN: string;
	GAME_CONTAINER: DurableObjectNamespace<import("./src/worker").GameContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "GameContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_MODE" | "REALTIME_SFU_APP_ID" | "REALTIME_SFU_BEARER_TOKEN">> {}
}
