...
const SENSITIVE_NAME =
  "(?:REALTIME_SFU_BEARER_TOKEN|REALTIME_SFU_APP_SECRET|REALTIME_APP_TOKEN|CALLS_APP_(?:TOKEN|SECRET)|APP_(?:TOKEN|SECRET)|OPENAI_API_KEY|ELEVENLABS_API_KEY|CF_API_TOKEN|CLOUDFLARE_API_TOKEN|SEMGREP_APP_TOKEN)";
